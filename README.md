...
3. Create a new package called *com.ieti.ieti.dto* and inside define your *UserDto* object with at least the following fields:
    * name.
    * email.
    * lastName.
4. Create a new package called *com.ieti.ieti.data* and inside define your *User* com.ieti.ieti.data object with at least the following fields:
    * id.
    * name.
    * email.
    * lastName.
...
**Java:**
  ...
  **Kotlin:**
  ...
  ```
6. Create an implementation of the UserService using a HashMap com.ieti.ieti.data structure inside.
7. Make your com.ieti.ieti.service implementation *UserServiceHashMap* injectable using the *@Service* annotation.
8. Create a new package called *com.ieti.ieti.controller* and create a new class *UserController* inside.
